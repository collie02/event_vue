            ...
            {leaderboardData.map((user, index) => (
              ...
              >
                ...
                <div className="w-7 h-7 flex items-center justify-center">
                  ...
                  <div
                    className={`w-7 h-7 flex items-center justify-center text-black/60 text-xl font-bold ${user.badge ? "hidden" : ""}`}
                  >
                    {user.rank}
                  </div>
                </div>
                ...
                {/* Amount */}
                <div className="text-right flex-shrink-0">
                  <div className="text-black/60 text-sm">{user.amount}</div>
                </div>
              </div>
            ))}
          </div>
