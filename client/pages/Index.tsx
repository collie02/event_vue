        ...
        <div className="max-w-6xl mx-auto px-4 md:px-8 py-8 md:py-16">
          ...
          <div className="py-4">
            ...
            <div className="flex justify-center mb-8">
              <Button className="bg-cos-blue hover:bg-cos-blue/90 text-white px-8 py-3 text-sm font-medium uppercase tracking-wide">
                立即參加
              </Button>
            </div>
          </div>
          ...
          {/* Divider */}
          <div className="border-t border-black/12 mb-8" />
          ...
          <div className="flex justify-center mt-8">
            <Button className="bg-cos-blue hover:bg-cos-blue/90 text-white px-8 py-3 text-sm font-medium uppercase tracking-wide w-full md:w-auto">
              立即參加
            </Button>
          </div>
        </div>
